...
class RecursiveFusion(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, revisits,use_batchnorm=False,):
        ...
        #     in_channels=in_channels,  # revisits as channels
    ...
    def forward(self, x):
        ...
        x = x.squeeze(1)  # (batch_size, channels, height, width)
        #x = self.decoder(x)
        return x