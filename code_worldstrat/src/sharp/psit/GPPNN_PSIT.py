...
import numpy as np
from .modules_psit import InvertibleConv1x1
from .refine_psit import Refine1
...
class GPPNN_With_MISR(nn.Module):
    def __init__(self,
                 ms_channels,
                 pan_channels,
                 n_feat,
                 n_layer=0):
        super(GPPNN_With_MISR, self).__init__()
...
class GPPNN_Only_Sharpening(nn.Module):
    def __init__(self,
                 ms_channels,
                 pan_channels,
                 n_feat,
                 n_layer=0):
        super(GPPNN_Only_Sharpening, self).__init__()
        self.conv_process = Conv_Process(ms_channels,pan_channels,n_feat//2)
        self.conv_fusion = Conv_Fusion(n_feat//2,n_feat//2)
