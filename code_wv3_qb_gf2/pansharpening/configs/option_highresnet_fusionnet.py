...
class parser_args(TaskDispatcher, name='HighResNet_FusionNet'):
    def __init__(self, cfg=None):
        ...
        ##
        parser.add_argument('--arch', '-a', metavar='ARCH', default='HighResNet_FusionNet', type=str,
                            choices=['PanNet', 'DiCNN', 'PNN', 'FusionNet'])
        parser.add_argument('--dataset', default={'train': 'wv3', 'val': 'TestData_wv3'}, type=str,
        ...
        cfg.save_fmt = "not mat"
        # cfg.workflow = [('train', 10), ('val', 1)]
        cfg.workflow = [('train', 100), ('val', 1)]
