...
from .model_trnet_pan_msdcnn import TRNet_PAN_MSDCNN
import numpy as np
import kornia
import torch
...
class build_trnet_msdcnn(PanSharpeningModel, name='TRNet_PAN_MSDCNN'):
    def __call__(self, cfg):
        ...
        model = TRNet_PAN_MSDCNN(spectral_num, criterion).cuda()
