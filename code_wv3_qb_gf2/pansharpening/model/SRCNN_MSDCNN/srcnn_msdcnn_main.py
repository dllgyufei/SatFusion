...
from .model_srcnn_msdcnn import SRCNN_MSDCNN
import numpy as np
import kornia
import torch
...
class build_srcnn_msdcnn(PanSharpeningModel, name='SRCNN_MSDCNN'):
    def __call__(self, cfg):
        ...
        model = SRCNN_MSDCNN(spectral_num, criterion).cuda()
