...
from .model_highresnet_dicnn import HighResNet_DiCNN
import numpy as np
import kornia
import torch
...
class build_highresnet_dicnn(PanSharpeningModel, name='HighResNet_DiCNN1'):
    def __call__(self, cfg):
        ...
        model = HighResNet_DiCNN(spectral_num, criterion).cuda()
