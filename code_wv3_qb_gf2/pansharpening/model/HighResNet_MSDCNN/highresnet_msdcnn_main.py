...
from .model_highresnet_msdcnn import HighResNet_MSDCNN
import numpy as np
import kornia
import torch
...
class build_highresnet_msdcnn(PanSharpeningModel, name='HighResNet_MSDCNN'):
    def __call__(self, cfg):
        ...
        model = HighResNet_MSDCNN(spectral_num, criterion).cuda()
