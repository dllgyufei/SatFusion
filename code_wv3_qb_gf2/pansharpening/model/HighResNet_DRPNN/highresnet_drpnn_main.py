...
from .model_highresnet_drpnn import HighResNet_DRPNN
import numpy as np
import kornia
import torch
...
class build_highresnet_drpnn(PanSharpeningModel, name='HighResNet_DRPNN'):
    def __call__(self, cfg):
        ...
        model = HighResNet_DRPNN(spectral_num, criterion).cuda()
