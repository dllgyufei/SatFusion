...
from .model_highresnet_u2net import HighResNet_U2Net
import numpy as np
import kornia
import torch
...
class build_highresnet_u2net(PanSharpeningModel, name='HighResNet_U2Net'):
    def __call__(self, args):
        ...
        model = HighResNet_U2Net(spectral_num, criterion, dim=32).cuda()
