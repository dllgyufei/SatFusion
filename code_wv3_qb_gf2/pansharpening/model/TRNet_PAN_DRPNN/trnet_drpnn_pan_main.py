...
from .model_trnet_pan_drpnn import TRNet_PAN_DRPNN
import numpy as np
import kornia
import torch
...
class build_trnet_drpnn(PanSharpeningModel, name='TRNet_PAN_DRPNN'):
    def __call__(self, cfg):
        ...
        model = TRNet_PAN_DRPNN(spectral_num, criterion).cuda()
