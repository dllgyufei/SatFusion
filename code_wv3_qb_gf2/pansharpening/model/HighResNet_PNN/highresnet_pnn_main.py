...
from .model_highresnet_pnn import HighResNet_PNN
import numpy as np
import kornia
import torch
...
class build_highresnet_pnn(PanSharpeningModel, name='HighResNet_PNN'):
    def __call__(self, cfg):
        ...
        model = HighResNet_PNN(spectral_num, criterion).cuda()
