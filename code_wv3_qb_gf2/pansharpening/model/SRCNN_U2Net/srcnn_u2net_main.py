...
from .model_srcnn_u2net import SRCNN_U2Net
import numpy as np
import kornia
import torch
...
class build_srcnn_2net(PanSharpeningModel, name='SRCNN_U2Net'):
    def __call__(self, args):
        ...
        model = SRCNN_U2Net(spectral_num, criterion, dim=32).cuda()
