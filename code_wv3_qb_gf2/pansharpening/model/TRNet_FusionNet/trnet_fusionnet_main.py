...
from .model_trnet_fusionnet import TRNet_FusionNet
import numpy as np
import kornia
import torch
...
class build_trnet_fusionnet(PanSharpeningModel, name='TRNet_FusionNet'):
    def __call__(self, args):
        ...
        model = TRNet_FusionNet(spectral_num, criterion).cuda()
