...
class RAMS_DRPNN(nn.Module):
    def __init__(self, spectral_num, criterion, channel=32):
        super(RAMS_DRPNN, self).__init__()
    ...
    def train_step(self, data, *args, **kwargs):
        ...
        save_train_dir = r"/home/tongyufei/Pansharpen-DL-toolbox/UDL/results/image/RAMS_DRPNN/train"
    ...
    def val_step(self, data, *args, **kwargs):
        ...
        #     2. 保存图像个数： 总共只需要记录 5 对多时相多光谱图像 ms_made 即可，即可以选取第一批次的前 5 对多时相多光谱图像记录
        #     3. 每一对多时相多光谱图像之中有8张图像（即，revisited=8），可以利用showimage8提取图像之后，将这八张图像进行合并，保存为一张图片
        save_val_dir = r"/home/tongyufei/Pansharpen-DL-toolbox/UDL/results/image/RAMS_DRPNN/test"
