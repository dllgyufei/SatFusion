...
from .model_trnet_u2net import TRNet_U2Net
import numpy as np
import kornia
import torch
...
class build_trnet_u2net(PanSharpeningModel, name='TRNet_U2Net'):
    def __call__(self, args):
        ...
        model = TRNet_U2Net(spectral_num, criterion, dim=32).cuda()
