...
from .model_trnet_msdcnn import TRNet_MSDCNN
import numpy as np
import kornia
import torch
...
class build_trnet_msdcnn(PanSharpeningModel, name='TRNet_MSDCNN'):
    def __call__(self, cfg):
        ...
        model = TRNet_MSDCNN(spectral_num, criterion).cuda()
