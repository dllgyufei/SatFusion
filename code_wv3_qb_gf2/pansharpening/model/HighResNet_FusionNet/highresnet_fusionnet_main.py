...
from .model_highresnet_fusionnet import HighResNet_FusionNet
import numpy as np
import kornia
import torch
...
class build_highresnet_fusionnet(PanSharpeningModel, name='HighResNet_FusionNet'):
    def __call__(self, args):
        ...
        model = HighResNet_FusionNet(spectral_num, criterion).cuda()
