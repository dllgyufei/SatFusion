...
class CropDict:
    ...
    to the original/source image_wv3. """
    ...
    def __init__(self, start_x, start_y, end_x, end_y, src="lr"):
        ...
        src : str, optional
            Source of the original/source image_wv3, by default 'lr'.
        """
...
class RandomCropDict:
    ...
    proportional to the original/source image_wv3. """
    ...
    def __init__(self, src, size, batched=False):
        ...
        ----------
        src : str
            Source of the original/source image_wv3.
        size : tuple of int
            Size of the crop.
...
class FilterData:
    ...
    def __init__(self, thres=0.4, values=(0,), fill="zero", batched=False):
...
def lanczos_shift(x, shift, padding=3, kernel_lobes=3):
    """ Shifts an image_wv3 by convolving it with a Lanczos kernel.
    ...
    # 1D-convolve image_wv3 with kernels: shifts image_wv3 on x- then y-axis.
    x = torch.conv1d(
        x,
...
class Shift:
    """ Sub-pixel image_wv3 shifter with Lanczos shifting and interpolation kernels. """
    ...
    def __call__(self, x, shift):
        """ Shift an image_wv3 by convolving it with a Lanczos kernel.
        ...
        -------
        Tensor
            Shifted image_wv3, (batch_size, channels, height, width).
        """
...
class WarpPerspective:
    ...
    def __call__(self, x, warp):
        """ Warp an image_wv3 by perspective transformation.
        ...
        -------
        Tensor
            Warped image_wv3, (batch_size, channels, height, width).
        """
        """
        Args:
