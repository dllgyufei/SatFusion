...
from .model_trnet_pan_fusionnet import TRNet_PAN_FusionNet
import numpy as np
import kornia
import torch
...
class build_trnet_pan_fusionnet(PanSharpeningModel, name='TRNet_PAN_FusionNet'):
    def __call__(self, args):
        ...
        model = TRNet_PAN_FusionNet(spectral_num, criterion).cuda()
