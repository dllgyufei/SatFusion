...
from .model_trnet_pan_pnn import TRNet_PAN_PNN
import numpy as np
import kornia
import torch
...
class build_trnet_pan_pnn(PanSharpeningModel, name='TRNet_PAN_PNN'):
    def __call__(self, cfg):
        ...
        model = TRNet_PAN_PNN(spectral_num, criterion).cuda()
