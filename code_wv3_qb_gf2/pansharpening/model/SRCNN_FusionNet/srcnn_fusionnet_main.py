...
from .model_srcnn_fusionnet import SRCNN_FusionNet
import numpy as np
import kornia
import torch
...
class build_srcnn_fusionnet(PanSharpeningModel, name='SRCNN_FusionNet'):
    def __call__(self, args):
        ...
        model = SRCNN_FusionNet(spectral_num, criterion).cuda()
