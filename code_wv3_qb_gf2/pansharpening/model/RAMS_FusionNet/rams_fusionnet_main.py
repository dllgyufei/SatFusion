...
from .model_rams_fusionnet import RAMS_FusionNet
import numpy as np
import kornia
import torch
...
class build_rams_fusionnet(PanSharpeningModel, name='RAMS_FusionNet'):
    def __call__(self, args):
        ...
        model = RAMS_FusionNet(spectral_num, criterion).cuda()
